...
You have to design & build the backend for the application and the ability for the users to check products, find recipes, locate stores etc.
...
azaylamba/lays: Basic functionalities of Lay's website (github.com) 
